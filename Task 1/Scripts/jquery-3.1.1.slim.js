 ...
 */
function NUnit.Framework.Assert( fn ) {
...
setDocument = Sizzle.setDocument = function( node ) {
	...
	support.attributes = NUnit.Framework.Assert(function( el ) {
		el.className = "i";
	...
	support.getElementsByTagName = NUnit.Framework.Assert(function( el ) {
	...
	support.getById = NUnit.Framework.Assert(function( el ) {
	...
	if ( (support.qsa = rnative.test( document.querySelectorAll )) ) {
		...
		NUnit.Framework.Assert(function( el ) {
...
support.sortDetached = NUnit.Framework.Assert(function( el ) {
...
if ( !NUnit.Framework.Assert(function( el ) {
...
if ( !support.attributes || !NUnit.Framework.Assert(function( el ) {
	el.innerHTML = "<input/>";
